  ...
  <div class="container mx-auto">
    ...
    <div class="flex flex-col flex-wrap mb-2 mt-12 px-4 lg:px-0">
      <div class="grid inline-grid grid-cols-2 mb-5">
        <h1 class="text-3xl font-bold text-elucidator-700 dark:text-dark-repulser-400">Todos los artículos</h1>
        <router-link
          to="/blog"
          class="cursor-pointer text-right m/y-auto text-elucidator-700 dark:text-dark-repulser-400"
